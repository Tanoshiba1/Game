...
Window_GamepadConfig.prototype.makeCommandList = function(index) {
        ...
        this.addCommand(this.getButtonTypeText(8), 'reset', true);
        this.addCommand(this.getButtonTypeText(9), 'finish', true);
};
...
Window_GamepadConfig.prototype.getButtonTypeText = function(index) {
        ...
        if (index === 8) return Yanfly.Param.GamepadConfigResetTx;
        if (index === 9) return Yanfly.Param.GamepadConfigFinishTx;
        return '';
};
