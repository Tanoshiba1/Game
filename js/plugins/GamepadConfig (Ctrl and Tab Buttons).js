 ...
 *
 * @param RotLeft Button
 * @desc This is the command name for the Rotation Left button.
 * @default Rotation Left
 *
 * @param RotLeft Help
 * @desc This is the help description for the Rotation Left button.
 * @default Use it to rotate the camera 90º to left.
 *
 * @param RotRight Button
 * @desc This is the command name for the Rotation Right button.
 * @default Rotation Right
 *
 * @param RotRight Help
 * @desc This is the help description for the Rotation Right button.
 * @default Use it to rotate the camera 90º to right.
 *
 * @param PageUp Button
 ...
 * @default Use it to turn up the camera's pitch and quickly scroll up menus.
 *
 ...
 * @default Use it to turn down the camera's pitch and quickly scroll down menus.
 *
 * @param Control Button
 * @desc This is the command name for the Control button.
 * @default Control
 *
 * @param Control Help
 * @desc This is the help description for the Control button.
 * @default Use it to change the clock mode and hide it.
 *
 * @param Tab Button
 ...
 * @default Use it to change the clock HUD's position.
 * 
 * @param Reset Default
...
Yanfly.Param.GamepadConfigRotLeftTx = String(Yanfly.Parameters['RotLeft Button']);
Yanfly.Param.GamepadConfigRotLeftHelp = String(Yanfly.Parameters['RotLeft Help']);
Yanfly.Param.GamepadConfigRotRightTx = String(Yanfly.Parameters['RotRight Button']);
Yanfly.Param.GamepadConfigRotRightHelp = String(Yanfly.Parameters['RotRight Help']);
...
Yanfly.GamepadConfig.Window_Options_cursorRight =
        Window_Options.prototype.cursorRight;
Window_Options.prototype.cursorRight = function() {
  if (this.commandSymbol(this.index()) === 'gamepadConfig') {
  				Window_Command.prototype.processOk.call(this);
        } else {
                Yanfly.GamepadConfig.Window_Options_cursorRight.call(this);
        }
};

Yanfly.GamepadConfig.Window_Options_cursorLeft =
        Window_Options.prototype.cursorLeft;
Window_Options.prototype.cursorLeft = function() {
  if (this.commandSymbol(this.index()) === 'gamepadConfig') {
  				Window_Command.prototype.processOk.call(this);
        } else {
                Yanfly.GamepadConfig.Window_Options_cursorLeft.call(this);
        }
};
...
Window_GamepadConfig.prototype.makeCommandList = function(index) {
        ...
        this.addCommand(this.getButtonTypeText(10), 'reset', true);
        this.addCommand(this.getButtonTypeText(11), 'finish', true);
};
...
Window_GamepadConfig.prototype.getButtonTypeText = function(index) {
        ...
        if (index === 4) return Yanfly.Param.GamepadConfigRotLeftTx;
        if (index === 5) return Yanfly.Param.GamepadConfigRotRightTx;
  		if (index === 6) return Yanfly.Param.GamepadConfigPgUpTx;
   		if (index === 7) return Yanfly.Param.GamepadConfigPgDnTx;
  		if (index === 8) return Yanfly.Param.GamepadConfigControlTx;
   		if (index === 9) return Yanfly.Param.GamepadConfigTabTx;
        if (index === 10) return Yanfly.Param.GamepadConfigResetTx;
        if (index === 11) return Yanfly.Param.GamepadConfigFinishTx;
        return '';
};
...
Window_GamepadConfig.prototype.getButtonKey = function(index) {
        ...
        if (index === 4) return 'rotleft';
        if (index === 5) return 'rotright';
        if (index === 6) return 'pageup';
        if (index === 7) return 'pagedown';
        if (index === 8) return 'control';
        if (index === 9) return 'tab';
};
...
Window_GamepadConfig.prototype.updateHelp = function() {
    if (!this._helpWindow) return;
                ...
                case 3:
                        ...
                        break;
                case 4:
                        this._helpWindow.setText(Yanfly.Param.GamepadConfigRotLeftHelp);
                        break;
                case 5:
                        this._helpWindow.setText(Yanfly.Param.GamepadConfigRotRightHelp);
                        break;
		        case 6:
		        ...
		        case 7:
		            	...
		            	break;
		        case 8:
		            	this._helpWindow.setText(Yanfly.Param.GamepadConfigControlHelp);
		            	break;
		        case 9:
